...
func (i *ContainersImageRegistry) GetContentFS(ctx context.Context, catalog *catalogdv1alpha1.ClusterCatalog) (fs.FS, error) {
	...
	dataPath := filepath.Join(i.BaseCachePath, catalog.Name, ref, "configs")
...
func (i *ContainersImageRegistry) Unpack(ctx context.Context, catalog *catalogdv1alpha1.ClusterCatalog) (*Result, error) {
	...
	//
	//////////////////////////////////////////////////////
	i.Logger.Infof("Resolving canonical reference for catalog image")
	imgRef, canonicalRef, specIsCanonical, err := resolveReferences(ctx, catalog.Spec.Source.Image.Ref, srcCtx)
	if err != nil {
		return nil, err
	}
	i.Logger.Infof("Canonical image reference: %s", canonicalRef)
	...
	if unpackStat, err := os.Stat(unpackPath); err == nil {
		...
		i.Logger.Infof("No new updates to catalog")
	...
	//
	//////////////////////////////////////////////////////
	i.Logger.Infof("Unpacking image...")
